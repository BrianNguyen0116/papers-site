  ...
  return (
    <>
        ...
        <div className="my-6">
          ...
          >
            <h1 className="text-xl">Delivering exceptional construction experiences through quality craftsmanship, unwavering integrity, and unparalleled customer service.</h1>
          </Fade>
        </div>
